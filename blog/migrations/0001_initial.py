    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('0', 'DRAFTS'), ('1', 'PUBLISH')], default=0, max_length=1)),
                ('section', models.CharField(choices=[('Recent', 'Recent'), ('Populer', 'Popular'), ('Trending', 'Trending')], max_length=100)),
